...
namespace WCFClient_E5
{
    public class HttpHelper
    {
        ...
        #region 处理response中的cookie，得到工整的"name=value;"的字符串cookie
        public string GetCookie(string cookie, string oldCookie)
        {
            if (cookie == null)
            {
                return oldCookie;
            ...
            List<string> oldList = oldCookie.Split(new char[] { ';', ',' }, StringSplitOptions.RemoveEmptyEntries).ToList();
            List<string> newList = cookie.Split(new char[] { ';', ',' }, StringSplitOptions.RemoveEmptyEntries).ToList();
            //删除response的cookie中没有意思的键值。
            newList.RemoveAll((a) =>
            {
                a = a.ToLower();
                return a.Contains("path") | a.Contains("domain") | a.Contains("expires") | !a.Contains("=") | a.Contains("expired") | a.Contains("max-age") | a.Contains("as_sfa") | a.Contains("max-age") | a.Contains("version");
            });
            oldList.RemoveAll((a) =>
            {
                a = a.ToLower();
                return a.Contains("path") | a.Contains("domain") | a.Contains("expires") | !a.Contains("=") | a.Contains("expired") | a.Contains("max-age") | a.Contains("as_sfa") | a.Contains("max-age");
            });
            ...
            {
                newCookie += key + "=" + dic[key] + ";";
            }
            return newCookie + "as_sfa=Mnxjbnxjbnx8emhfQ058Y29uc3VtZXJ8aW50ZXJuZXR8MHwwfDE=;";
        }
        #endregion
    }
    #region public calss
