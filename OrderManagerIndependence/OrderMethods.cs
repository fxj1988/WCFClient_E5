...
namespace OrderManagerIndependence
{
    public class OrderMethods
    {
        ...
        public Accounts BuyPhoneTest(Accounts userInfo)
        {
            userInfo.remarks = "测试";
            return userInfo;
        }
        ...
        public Accounts BuyPhone(Accounts userInfo, int timeInterval = 500)
        {
            ...
            string[] iPhone_select = { "x", "5.8", "64", "silver", "MQA62CH", "1", "IPHONEX_GSM" };
            string[] iPhone_se = { "se", "4", "32", "silver", "MP832CH", "1" };
            ...
            string cookie = "";
            string iphone = iPhone_select[0];
            string size = iPhone_select[1];
            string gb = iPhone_select[2];
            string col = iPhone_select[3];
            string product = iPhone_select[4];
            string screensize = size.Replace('.', '_');
            string quantity = iPhone_select[5];
            string IPHONEX_GSM = iPhone_select[6];
            ...
            //https://www.apple.com/cn/shop/buy-iphone/iphone-se/MP832CH/A?product=MP832CH%2FA&purchaseOption=fullPrice&step=select&atbtoken=01daf21504295b6cd17474559f0d546bc66fe21c&complete=true&dimensionCapacity=32gb&dimensionColor=silver&dimensionScreensize=4inch&add-to-cart=add-to-cart
            #endregion
            ...
            string para_atb_token = "";
            para_atb_token = Regex.Match(result.Cookie, "as_atb=(.+?);").Groups[1].ToString().Split('|')[2];
            #endregion
            Thread.Sleep(timeInterval);
            ...
            {
                userInfo.remarks = "未知登录失败"+ chr.ToString();
                return userInfo;
            }
            #endregion
            Thread.Sleep(timeInterval);
            ...
            userInfo.w1 = match_alipay.Value;
            userInfo.w1Remark = iphone+ "/" + size + "/" + gb + "/" + col ;
